...
const WINDOWS_ENROLLMENT_COMMAND =
  "Invoke-WebRequest -UseBasicParsing -Headers @{ 'X-BB-Enrollment' = 'bbde_TZpKWsJpWiPulVIRKNENmEVtvNwnEwDobjPFlnlsyCUUzorssgdxmgxUblRIWAUA' } -Uri 'https://bb.example.com/install.ps1'";

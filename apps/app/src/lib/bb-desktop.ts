...
export const MACOS_WINDOW_DRAG_CLASS = DESKTOP_WINDOW_DRAG_CLASS;
export const MACOS_APP_REGION_NO_DRAG_CLASS = DESKTOP_APP_REGION_NO_DRAG_CLASS;
export const MACOS_WINDOW_NO_DRAG_CLASS = DESKTOP_WINDOW_NO_DRAG_CLASS;
...
export const DESKTOP_CHROME_CONTROL_NO_DRAG_CLASS =
